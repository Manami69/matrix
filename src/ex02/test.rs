...
pub fn ex02() {
    ...
    println!(
        "{}",
        lerp(Complexf32::new(1., 1.), Complexf32::new(2., 2.), 0.5)
    );
    println!(
        "{}",
        lerp(
            Vector::from([Complexf32::new(1., 1.), Complexf32::new(2., 2.)]),
            Vector::from([Complexf32::new(3., 3.), Complexf32::new(4., 4.)]),
            0.3
        )
    );
    println!(
        ...
        lerp(
            ...
            Matrix::from([
                [Complexf32::new(3., 3.), Complexf32::new(4., 4.)],
                [Complexf32::new(3., 3.), Complexf32::new(4., 4.)]
            ]),
            0.3
        )
