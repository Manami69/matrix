...
impl Matrix<f32> {
	...
	pub fn rotation( angle: f32, axis: Vector<f32>) -> Matrix<f32> {
		...
		let sin = angle.sin();
		let cos1 = 1. - cos;
		Matrix::from([[cos + (rx * rx) * cos1, 		rx * ry * cos1 - rz * sin,	rx * rz * cos1 + ry * sin,		0.],
					  [ry * rx * cos1 + rz * sin, 	cos + (ry * ry) * cos1		, ry * rz * cos1 - rx * sin,	0.],
					  [rz * rx * cos1 - ry * sin,	rz * ry * cos1 + rx * sin,	cos + (rz * rz) * cos1, 		0.],
					  [0., 0., 0., 1.]])
	}
}